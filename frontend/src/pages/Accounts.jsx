                        ...
                        {(() => {
                            ...
                            if (isCreditCard) {
                                ...
                                if (acc.last_4_digits) {
                                    showLogo = <img src="/visa-logo-v2.png" alt="Visa" className="h-6 w-auto object-contain drop-shadow-md" />;
                                ...
                                if (acc.aliases && acc.aliases.length > 0) {
                                    ...
                                    showLogo = <img src="/mada-logo.png" alt="Mada" className="h-9 w-auto object-contain drop-shadow-[0_0_2px_rgba(255,255,255,0.8)]" />;
            ...
            <div className="flex justify-between items-center mb-2">
                ...
                <div className="flex flex-col items-end">
                    {acc.account_type === 'Credit Card' ? (
                        ...
                        <img src="/mada-logo.png" alt="Mada" className="w-10 h-auto object-contain drop-shadow-[0_0_2px_rgba(255,255,255,0.8)]" />
                    )}
                </div>
            </div>
