...
import { LayoutDashboard, Wallet, CreditCard, Receipt, FileBarChart, Settings, TrendingDown, LayoutList } from 'lucide-react';
...
const Sidebar = () => {
    const navItems = [
        ...
        { path: '/obligations-new', label: 'Manager New', icon: LayoutList }, // New Item
